...
var utf8Lib = map[string]GoFunction{
	"len":       utfLen,					//返回字符串中utf8字符数
	"offset":    utfByteOffset,				//返回某个utf8字符在字符串中的字节偏移量
	"codepoint": utfCodePoint,				//返回字符串偏移量处的Unicode字符代码点	
	"char":      utfChar,					//对代码点进行utf8编码，并生成字符串
	"codes":     utfIterCodes,				//对utf8字符串中的Unicode代码点进行迭代
	/* placeholders */
	"charpattern": nil,
}
